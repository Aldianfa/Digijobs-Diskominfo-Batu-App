                    ...
                    <tbody>
                        @foreach ($kegiatan as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('kegiatan.show', $item->id_kegiatan) }}" class="btn btn-info btn-sm">Detail</a>
                                    <a href="{{ route('kegiatan.edit', $item->id_kegiatan) }}" class="btn btn-warning btn-sm">Edit</a>
                    ...
                    <tbody>
                        @foreach ($logkegiatan as $item)
                            <tr>
                                ...
                                <td>{{$item->id ? $item->newusers->nama : 'Tidak Didispo'}}</td>
                                <td>
                                    <a href="{{ route('logkegiatan.showlog', $item->id_log) }}" class="btn btn-info btn-sm">Detail</a>
                                    <a href="{{ route('logkegiatan.edit', $item->id_log) }}" class="btn btn-warning btn-sm">Edit</a>
