            ...
            <div class="card-body">
                ...
                <form action="{{ route('kegiatan.update', $kegiatan->id_kegiatan) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <select class="form-control single-select-field" name="id_surat"
                            ...
                            @foreach ($surat as $item)
                                <option value="{{ $item->id_surat ?? 'Tidak Berdasarkan Surat'}}"
                                    ...
                                    -- {{ $item->subklasifikasis->nama_sub_klasifikasi }} - {{ $item->perihal }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="jenis_kegiatan" class="form-control">
                                    <option value="{{ $kegiatan->jenis_kegiatan }}">{{ $kegiatan->jenis_kegiatan }}</option>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="mb-3">
                                <label for="bidangkegiatan">Pejabat Peniliai :</label>
